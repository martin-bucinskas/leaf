...
cargo run -- assemble --inputs fixtures/syscall.leaf --outputs fixtures/out/syscall.leafobj
cargo run -- assemble --inputs fixtures/fibonacci.leaf --outputs fixtures/out/fibonacci.leafobj
cargo run -- assemble --inputs fixtures/all.leaf --outputs fixtures/out/all.leafobj
...
cargo run -- link --output fixtures/out/exe/syscall.leafexe fixtures/out/syscall.leafobj
cargo run -- link --output fixtures/out/exe/fibonacci.leafexe fixtures/out/fibonacci.leafobj
cargo run -- link --output fixtures/out/exe/all.leafexe fixtures/out/all.leafobj
